...
parser.add_argument(
    ...
    required=True,
    type=str,
    help="FASTA of unaligned study sequences (e.g. "
...
parser.add_argument(
    ...
    required=True,
    type=str,
    help="Output folder for final files.",
)
...
parser.add_argument(
    ...
    default="mp",
    choices=HSP_METHODS,
    help="HSP method to use." + '"mp": predict discrete traits using max parsimony. '
